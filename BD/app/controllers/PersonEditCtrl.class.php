...
class PersonEditCtrl {
	...
	public function validateSave() {
		...
		$phonePattern = "/^\+?[0-9]{3}[- ]?[0-9]{3}[- ]?[0-9]{3}$/";
		if (!preg_match($phonePattern, $this->form->phone)) {
			getMessages()->addError('Zły format numeru telefonu. Przykłady: 123-456-789, 123 456 789, 123456789');
		}
